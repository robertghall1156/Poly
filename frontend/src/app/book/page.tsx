  ...
  return (
    <div className="border-b border-zinc-200 px-3 py-2 last:border-b-0">
      ...
      <div className="mt-1 flex flex-wrap gap-3 text-xs text-zinc-500">
        {note.links.story ? (
          <Link href={`/stories/${note.links.story.id}`} className="hover:text-accent-strong">
            Story: {note.links.story.title}
          </Link>
        ) : null}
        {note.links.principle ? (
          <Link href={`/principles/${note.links.principle.id}`} className="hover:text-accent-strong">
            Principle: {note.links.principle.title}
          </Link>
        ) : null}
        {note.links.content ? (
          <Link href={`/content/${note.links.content.id}`} className="hover:text-accent-strong">
            Content: {note.links.content.title}
          </Link>
        ) : null}
        {note.links.video ? (
          <Link href={`/videos/${note.links.video.id}`} className="hover:text-accent-strong">
